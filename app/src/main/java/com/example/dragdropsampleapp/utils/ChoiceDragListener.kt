package com.example.dragdropsampleapp.utils
...
import com.example.dragdropsampleapp.R
...
//                v!!.invalidate()
                ...
                dragged.setBackgroundColor(ContextCompat.getColor(dragged.context,R.color.black))
